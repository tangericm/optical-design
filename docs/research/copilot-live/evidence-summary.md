# Optical copilot development evidence â€” 2026-09-12

The first bounded copilot workflow is implemented: explicit specification â†’ copied model â†’
baseline audit â†’ constrained refocus â†’ saved/reloaded candidate â†’ tolerance evidence.
...
Matching synthetic prescriptions: N-BK7 singlet, radii +50/âˆ’50 mm, glass thickness 5 mm,
entrance pupil diameter 10 mm, on-axis field, wavelength 0.55 Âµm, initial image gap 60 mm.
The allowed refocus range was 44â€“51 mm. Objective: minimum geometric centroid RMS spot;
hard constraints included EFL 48â€“51 mm, track â‰¤65 mm, RMS spot â‰¤30 Âµm and tangential MTF
at 20 cycles/mm â‰¥0.3. Sampling setting 128; 25-evaluation cap; 300-second cooperative deadline.
...
| RMS spot radius (Âµm) | 989.539913 | 14.814946 | 973.842028 | 14.271819 |
...
agreed at approximately 989.54 Âµm for the defocused singlet. The first-order EFL matches.
...
surface 1 radius uniform Â±0.05 mm, thickness Gaussian Ïƒ=0.01 mm. Six signed sensitivity
...
parameter readback and baseline restoration. The 95% Wilson interval is **83.887â€“100%**.
