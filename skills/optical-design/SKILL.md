...
Prescription audit/refocus/optimize/tolerance adapters remain restricted to centered spherical/plane
...
The source remains unchanged. Accept a candidate only when all
